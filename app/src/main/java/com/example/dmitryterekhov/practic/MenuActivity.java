...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bExercise = (Button)findViewById(R.id.bGoExercise);
        bCardio = (Button)findViewById(R.id.bGoCardio);
        ...
        bCardio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CardioExerciseActivity.class);
                startActivity(intent);
            }
        });
